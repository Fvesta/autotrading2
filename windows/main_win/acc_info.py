...
def newAccInfo(ui, accNo):    
    ...
    tableWidget = QTableWidget(accGroup)
    ...
    for var in makedVars:
        setattr(ui, f"{accNo}_{var}", locals()[var])